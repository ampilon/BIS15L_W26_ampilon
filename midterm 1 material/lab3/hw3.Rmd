...
```{r}
mountain_name <- c("mount_everest", "k2", "kangchenjunga", "lhotse", "makalu")
...
```{r}
mountains <- tibble(mountain_name, height_in_feet, height_in_meters)
```
...
```{r}
mountains <- tibble(mountain_name, height_in_feet, height_in_meters, first_climbed)
```
...
```{r}
summits<- c(12000,800,400,900,3000)
mountains <- tibble(mountain_name, height_in_feet, height_in_meters, first_climbed, summits)
```
...
```{r}
fatalities <- c(344,101,53,24,50)
mountains <- tibble(mountain_name, height_in_feet, height_in_meters, first_climbed, summits, fatalities)
```
...
```{r}
fatality_rate <- c(344/12000,101/800,53/400,24/900,50/3000)
mountains <- tibble(mountain_name, height_in_feet, height_in_meters, first_climbed, summits, fatalities, fatality_rate)
```
