...
ggplot(data=penguins,#specify the data
       mapping= aes(x=species, y=body_mass_g)) #map the asthetics
```
...
ggplot(data=penguins,
       mapping=aes(x=body_mass_g, y=flipper_length_mm)) + geom_point()
```
...
```{r}
ggplot(data=penguins,
       mapping=aes(x=body_mass_g, y=flipper_length_mm)) + geom_point(na.rm=T)
```
...
```{r}
ggplot(data=penguins,
       mapping=aes(x=body_mass_g, y=flipper_length_mm, color=species)) + geom_point(na.rm=T)+
  geom_smooth(method=lm, se=T)
```
...
```{r}
ggplot(data=penguins,
       mapping=aes(x=body_mass_g, y=flipper_length_mm)) + geom_point(mapping=aes(color=species))+
  geom_smooth(method=lm, se=T)
```
...
```{r}
ggplot(data=penguins,
       mapping=aes(x=body_mass_g, y=flipper_length_mm)) + geom_point(mapping=aes(color=species, shape=island))+
  geom_smooth(method=lm, se=T)
```
...
```{r}
ggplot(data=penguins,
       mapping=aes(x=body_mass_g, y=flipper_length_mm)) + geom_point(mapping=aes(color=species, shape = species))+
  geom_smooth(method=lm, se=T)+
labs(title = "Body Mass in g vs Flipper Length in mm", x="body mass in g")
```
...
```{r}
ggplot(data=penguins,
       mapping=aes(x=bill_length_mm, y=bill_depth_mm)) + geom_point()+
  geom_smooth(method=lm, se=T)+
...
```{r}
ggplot(data=penguins,
       mapping=aes(x=species))+geom_bar(mapping=aes(fill=species))
```
...
```{r}
ggplot(data=penguins,
       mapping=aes(x=island))+geom_bar(mapping=aes(fill=island))
```
...
```{r}
ggplot(data=penguins,
       mapping=aes(x=island))+geom_bar(mapping=aes(fill=species))
```
