...
```{r}
ggmap(map1) +
  geom_point(data = spiders, aes(longitude, latitude), size = 0.75, color = "pink1", alpha = 0.8)+
...
```{r}
ggmap(map2) +
  geom_point(data = grizzly, aes(longitude, latitude), size = 0.75, color = "brown", alpha = 0.8)+
  labs(x = "Longitude", y = "Latitude", title = "Grizzly Bear Sightings in Alaska")
```
