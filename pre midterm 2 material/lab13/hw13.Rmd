...
amniota_no_na %>%
  gg_miss_var()
# subspecies and female_body_mass_at_maturity_g have the most NA's
```
...
# we only have values for reptiles so we can not interpret anything about birds or mammals from this section of data. We might interpret it being missing for mammals an absence of egg which makes sense biologically. For birds we more likely interpret it as not measured. 
```
## Knit and Upload
