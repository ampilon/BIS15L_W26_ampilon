...
```{r}
#gabon%>%
  #select(transect_id, tree_species, breast_height)%>%
  #filter(tree_species > 15, Breast_height>50, breast_height<60)
#could not find data with tree species number or breast height
```
...
gabon%>%
  ...
  arrange(veg_rich)
#could not find data with tree species number?
#ideally would replace veg_rich with tree species richness
```
