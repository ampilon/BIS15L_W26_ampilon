...
#not reccomended for large files
```
...
# can use history to look at previos cammand
# control +R reverse search your history, press control R again to look at the previous previous one
